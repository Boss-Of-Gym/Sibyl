...
**Status:** `IN_PROGRESS` — 12/18 sub-stages `APPROVED` (all 4 MVP capabilities
plus Platform Foundation, all 6 Phase 2 capabilities, and the first Phase 3
capability, 9.11 — see the roadmap table below; last synced 2026-07-07)
...
| 9.11 | [Release Risk Analysis](9.11-release-risk-analysis/README.md) | 9.4, 9.7, 9.10 | Phase 3 | Fuses coverage, metrics, and regression-risk signal into a single release-level score. Scoped to a per-PR merge-readiness score, not a literal deployment/release entity. | `APPROVED` |
